...
public enum BankAlert {
    ...
    USER_CREATION_FAILED("❌ Failed to create user. Check console for details."),
    DEPOSIT_SUCCESSFULY("✅ Successfully deposited $%.2f to account %s!"),
    DEPOSIT_INVALID("❌ Please enter a valid amount."),
    DEPOSIT_TWO("Должно быть создано 2 аккаунта"),
    NEW_ACCOUNT_CREATED("✅ New Account Created! Account Number: "),
    TRANSFER_SUCCESSFULY("✅ Successfully transferred $%.2f to account %s!"),
    TRANSFER_AGAIN_SUCCESSFULY("✅ Transfer of $%.2f successful from Account"),
